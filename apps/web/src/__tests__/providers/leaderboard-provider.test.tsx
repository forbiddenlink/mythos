...
describe("LeaderboardProvider", () => {
  ...
  it.each(["null", "{}", "[null]", '[{"id":"bad"}]'])(
    "recovers from malformed stored rankings: %s",
    (saved) => {
      localStorageData["mythos-atlas-leaderboard"] = saved;
  ...
  describe("initial state", () => {
    ...
    it("should load existing entries from localStorage", async () => {
      ...
      localStorageData["mythos-atlas-leaderboard"] =
