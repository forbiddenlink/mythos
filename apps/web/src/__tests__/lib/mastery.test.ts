...
describe("mastery", () => {
  ...
  describe("getMasteryColor", () => {
    it("should return correct gradient for each level", () => {
      expect(getMasteryColor("novice")).toContain("muted");
      expect(getMasteryColor("bronze")).toContain("bronze");
      expect(getMasteryColor("silver")).toContain("muted-foreground");
      expect(getMasteryColor("gold")).toContain("gold");
      expect(getMasteryColor("mythic")).toContain("gold");
    });
  });

  describe("getMasteryTextColor", () => {
    it("should return correct text color for each level", () => {
      expect(getMasteryTextColor("novice")).toContain("muted-foreground");
      expect(getMasteryTextColor("bronze")).toContain("bronze");
      expect(getMasteryTextColor("silver")).toContain("muted-foreground");
      expect(getMasteryTextColor("gold")).toContain("gold");
      expect(getMasteryTextColor("mythic")).toContain("bronze");
    });
  });

  describe("getMasteryBorderColor", () => {
    it("should return correct border color for each level", () => {
      expect(getMasteryBorderColor("novice")).toContain("border");
      expect(getMasteryBorderColor("bronze")).toContain("bronze");
      expect(getMasteryBorderColor("silver")).toContain("border");
      expect(getMasteryBorderColor("gold")).toContain("gold");
      expect(getMasteryBorderColor("mythic")).toContain("bronze");
    });
  });
...
describe("calculatePantheonMastery", () => {
  ...
  it("should track viewed deities", () => {
    ...
    const result = calculatePantheonMastery(
      "greek-pantheon",
      ["zeus", "hera"],
      [],
      {},
  ...
  it("should include quiz scores in progress calculation", () => {
    const resultWithoutQuiz = calculatePantheonMastery(
      "greek-pantheon",
      [],
      [],
      {},
    ...
    const resultWithQuiz = calculatePantheonMastery("greek-pantheon", [], [], {
      "greek-pantheon-quiz": 100,
    });
