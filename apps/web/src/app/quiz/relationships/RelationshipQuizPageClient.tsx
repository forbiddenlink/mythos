...
import type { QuizDeity as Deity } from "@/lib/relationship-quiz";
...
interface RelationshipQuizPageClientProps {
  deitiesData: Deity[];
  relationshipsData: Relationship[];
}

export function RelationshipQuizPageClient({
  deitiesData,
  relationshipsData,
}: Readonly<RelationshipQuizPageClientProps>) {
