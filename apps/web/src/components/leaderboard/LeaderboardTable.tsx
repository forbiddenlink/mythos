...
const categoryLabels: Record<
  LeaderboardCategory,
  { label: string; icon: React.ReactNode; valueKey: keyof LeaderboardEntry }
> = {
  xp: {
    label: "Total XP",
  ...
  quiz: {
    ...
    valueKey: "quickQuizHighScore",
  },
  achievements: {
    label: "Achievements",
    icon: <Award className="h-4 w-4" />,
    valueKey: "achievementsUnlocked",
  },
  streak: {
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                {isCurrentUser && (
                  <Badge
                    variant="outline"
                    className="ml-2 text-xs border-gold/30 text-gold-text"
                  >
                    You
                  </Badge>
                )}
