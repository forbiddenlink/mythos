...
import { CinematicStory, type StoryScene } from '@/components/stories/CinematicStory';
  ...
  return (
    <main className="min-h-screen bg-midnight">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-b from-midnight via-midnight/80 to-transparent">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <Link href="/stories/titanomachy">
            <Button variant="ghost" className="text-parchment/70 hover:text-parchment">
      ...
      <CinematicStory
        ...
        scenes={titanomachyScenes}
      />

      {/* End CTA */}
      <section className="py-20 bg-midnight">
        <div className="container mx-auto px-4 text-center">
          <h2 className="font-serif text-3xl text-parchment mb-6">Continue Your Journey</h2>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link href="/pantheons/greek-pantheon">
              <Button variant="outline" className="border-gold/30 text-parchment hover:bg-gold/10">
