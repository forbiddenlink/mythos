  ...
  return (
    ...
    >
      ...
      <div className={cn(
        ...
        colorScheme === 'gold' && 'bg-gradient-to-b from-midnight/70 via-midnight/60 to-midnight/80',
        colorScheme === 'red' && 'bg-[radial-gradient(ellipse_at_center,_oklch(0.4_0.15_25_/_0.2)_0%,_transparent_70%)]',
        colorScheme === 'purple' && 'bg-[radial-gradient(ellipse_at_top,_oklch(0.4_0.15_300_/_0.3)_0%,_transparent_60%)]',
      )} />
