...
export function DomainParticles({
  domain,
  domains,
  className = "",
}: DomainParticlesProps) {
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/set-state-in-effect -- hydration: sync initial reduced motion preference
...
export function GoldenDustParticles({
  ...
  return (
    <div
      ...
      aria-hidden="true"
    >
      <Particles id="golden-dust" options={options} className="w-full h-full" />
    </div>
  );
}
